...
class AkanetTest extends TestCase
{
    ...
    {
        $this->provider = new \League\OAuth2\Client\Provider\Akanet(
            [
    ...
    {
        $this->provider->domain = 'https://itakademy.company.com';
        ...
        $providerAccessTokenUrl = $this->provider->domain . '/oauth/access_token';
        $providerResourceOwnerUrl = $this->provider->domain . '/api/v1/user';
